module Pod
  class Builder
    def initialize(source_dir, static_sandbox_root, dynamic_sandbox_root, public_headers_root, spec, embedded, mangle, dynamic, config, bundle_identifier, exclude_deps, xcode_build_options)
      ...
      @xcode_build_options = xcode_build_options
    end
    ...
    def compile(platform)
     ...
     if platform.name == :ios
      ...
      UI.puts "build options :" << @xcode_build_options
